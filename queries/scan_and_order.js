...
db.transactions.insert({user: 'gabriele', amount: 2, created_at: ISODate()})
db.transactions.insert({user: 'gabriele', amount: 4, created_at: ISODate()})
db.transactions.insert({user: 'francesco', amount: 2, created_at: ISODate()})
db.transactions.insert({user: 'francesco', amount: 6, created_at: ISODate()})
